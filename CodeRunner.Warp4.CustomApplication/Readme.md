...
Execute unit tests
```
    cd "CodeRunner.Warp4.CustomApplication/test/CodeRunner.Warp4.CustomApplication.Tests"
    dotnet test
```

Deploy application
```
    cd "CodeRunner.Warp4.CustomApplication/src/CodeRunner.Warp4.CustomApplication"
